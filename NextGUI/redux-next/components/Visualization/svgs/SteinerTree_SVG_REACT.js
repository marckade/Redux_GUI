        ...
        d3.json(problemUrl).then(function (data) {
            ...
            const node = svg
                ...
                .attr("stroke", function (d) {
                    if (d.attribute3 == "True") {
                      return "#FF0000"; // Outline color: red for green nodes with attribute2 as "True"
                    } else if (d.attribute2 == "True") {
                      return VisColors.Solution; // No outline for nodes with attribute2 as "False"
                    }
                  })
...
export default function SteinerTreeSvgReact(props) {
